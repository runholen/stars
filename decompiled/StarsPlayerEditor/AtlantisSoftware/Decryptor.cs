namespace AtlantisSoftware
{
    ...
    internal class Decryptor
    {
        private uint[] raw = new uint[] { 
            ...
            0xe5, 0xe9, 0xef, 0xf1, 0xfb, 0x101, 0x107, 0x10d, 0x10f, 0x115, 0x119, 0x11b, 0x125, 0x133, 0x137, 0x139
         };
        private uint RndA;
        private uint RndB;
        ...
        public void InitDecrypt(int a, int b, int c, int d, int e)
        {
            ...
            for (index = ((((e & 3) + 1) * ((c & 3) + 1)) * ((b & 3) + 1)) + a; index >= 1; index += -1)
            {
                this.NextRandom();
            }
        }
        ...
        public void ProcessBlock(ref byte[] Data, byte type, int Size)
        {
            if (type == 8)
            {
                ...
                int d = b;
                int e = ((Data[4] + (Data[5] * 0x100)) + (Data[6] * 0x10000)) + ((Data[7] * 0x10000) * 0x100);
