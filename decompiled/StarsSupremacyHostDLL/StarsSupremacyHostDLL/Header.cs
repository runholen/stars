namespace StarsSupremacyHostDLL
{
    ...
    public class Header : Header._Header
    {
        ...
        [DispId(1)]
        public byte[] StarsSupremacyHostDLL.Header._Header.Data
        {
            get
            {
                return this.xData;
        ...
        [DispId(7)]
        public int StarsSupremacyHostDLL.Header._Header.FileType
        {
            get
            {
                return this.xFiletype;
        ...
        [DispId(2)]
        public int StarsSupremacyHostDLL.Header._Header.Flags
        {
            get
            {
                return this.xFlags;
        ...
        [DispId(4)]
        public uint StarsSupremacyHostDLL.Header._Header.GameID
        {
            get
            {
                return this.xGameID;
        ...
        [DispId(3)]
        public int StarsSupremacyHostDLL.Header._Header.PlayerID
        {
            get
            {
                return this.xPlayerID;
        ...
        [DispId(5)]
        public int StarsSupremacyHostDLL.Header._Header.TurnNo
        {
            get
            {
        ...
        [DispId(6)]
        public int StarsSupremacyHostDLL.Header._Header.Version
        {
            get
            {
        ...
        public interface _Header
        {
            ...
            [DispId(3)]
            int PlayerID { [DispId(3)] get; [DispId(3)] set; }
